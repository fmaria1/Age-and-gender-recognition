 ...
 *                                                                         *
 *  File:        mat.py                                                    *
 *  Copyright:   (c) 2019, Abhishek Chatterjee                             *
 *  Website:     https://github.com/imdeepmind/processed-imdb-wiki-dataset *
 *  Description: The first mat.py file converts the mat files IMDB and     *
 *               WIKI dataset to .csv format and merge them into one file. *
 *                                                                         *
 **************************************************************************/
'''
